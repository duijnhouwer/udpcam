function [scum,vars]=varargskim(vars,name,varargin)
    
    % Skim names, name-value pairs, or name-(value-lists) pairs from a cell
    % array. The number of values taken after name is determined by the
    % function handles provided as the third argument and beyond. These
    % functions (e.g., @islogical) are used to validate the value.
    %
